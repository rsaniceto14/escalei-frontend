    ...
    <div className="min-h-screen bg-gradient-to-br from-echurch-50 via-background to-echurch-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl shadow-2xl border-0 bg-card/95 backdrop-blur-sm">
        <CardHeader className="text-center pb-4">
          ...
          <h2 className="text-2xl font-bold text-echurch-700">Configurar Músicas</h2>
          <p className="text-muted-foreground">Adicione o repertório musical da sua igreja</p>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          <div className="text-center py-12">
            ...
            <p className="text-sm text-muted-foreground">
              Aqui você poderá adicionar músicas, cifras e repertórios para suas escalas.
            </p>
          </div>
